    ...
    for(i=0;i<product.length;i++) {
        ...
        if (i !== 2) {           
            if (i == 0) {
                ...
                element_column.setAttribute("style","z-index: 0; border-radius: 15px; border-color: linear-gradient(to top, #0ABAD1, #5C4EE5); margin: 5px; backdrop-filter: blur(8px); width: 100%; display: flex; position: relative;");
