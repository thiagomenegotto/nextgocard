...
// ***** FONTS *****
    ...
    newStyle.appendChild(document.createTextNode(" @font-face { font-family: "Gilroy Font"; src: url('"https://github.com/thiagomenegotto/nextgocard/tree/main/uploads/2022/07/Gilroy-Bold.woff2"') format('woff2'); } "));
